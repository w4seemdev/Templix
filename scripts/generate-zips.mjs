/**
 * generate-zips.mjs
 * Generates downloadable zip files for all 55 Templix templates.
...
const TEMPLATES = [
  ...
  { id: '6',  title: 'StartKit — Startup',         demoUrl: '/preview/luminary',          techStack: ['React', 'TypeScript', 'Tailwind CSS'],                     pages: ['Home', 'Features', 'Contact'],                                     description: 'Free startup landing page with hero, features, and call-to-action sections.' },
  ...
  { id: '11', title: 'MedCare — Healthcare',       demoUrl: '/preview/nexus',             techStack: ['Next.js', 'TypeScript', 'Tailwind CSS'],                   pages: ['Home', 'Services', 'Doctors', 'Appointments', 'Contact'],         description: 'Clean and trustworthy healthcare website for clinics and medical practices.' },
  { id: '12', title: 'Coursify — Education',       demoUrl: '/preview/dashify',           techStack: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Stripe'],         pages: ['Home', 'Courses', 'Dashboard', 'Profile', 'Checkout'],            description: 'Feature-rich online course and education platform with enrollment and progress.' },
  { id: '13', title: 'Estatly — Real Estate',      demoUrl: '/preview/nexus',             techStack: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Mapbox'],         pages: ['Home', 'Listings', 'Property Detail', 'Agents', 'Contact'],       description: 'Sophisticated real estate listing website with property search and agents.' },
  ...
  { id: '24', title: 'Pulse — Analytics SaaS',     demoUrl: '/preview/dashify',           techStack: ['React', 'TypeScript', 'Recharts', 'Tailwind CSS'],         pages: ['Dashboard', 'Realtime', 'Pages', 'Sources', 'Funnels'],           description: 'Beautiful web analytics dashboard with real-time visitors and funnels.' },
  ...
  { id: '29', title: 'Atlas — Map SaaS',           demoUrl: '/preview/luminary',          techStack: ['React', 'TypeScript', 'Mapbox', 'Tailwind CSS'],           pages: ['Home', 'Map', 'Layers', 'Reports', 'Settings'],                   description: 'Location intelligence SaaS with maps, data layers, and territory management.' },
  { id: '30', title: 'Forge — Dev Tools',          demoUrl: '/preview/luminary',          techStack: ['React', 'TypeScript', 'Tailwind CSS', 'Shiki'],            pages: ['Home', 'Docs', 'Pricing', 'Changelog', 'Blog'],                   description: 'Technical SaaS landing page for developer tools with code previews.' },
  ...
  { id: '37', title: 'Verde — Eco & Sustainability', demoUrl: '/preview/travel-blog',     techStack: ['React', 'TypeScript', 'Tailwind CSS'],                     pages: ['Home', 'Mission', 'Products', 'Impact', 'Blog', 'Contact'],       description: 'Clean and purpose-driven sustainability brand website with impact metrics.' },
  { id: '38', title: 'Swift — Delivery App',       demoUrl: '/preview/app-landing',       techStack: ['React', 'TypeScript', 'Tailwind CSS', 'Framer Motion'],    pages: ['Home', 'How It Works', 'Restaurants', 'Download', 'FAQ'],         description: 'Food delivery app landing page with restaurant listings and app preview.' },
  ...
  { id: '42', title: 'IronPeak — Gym & Fitness',   demoUrl: '/preview/fitness',           techStack: ['React', 'TypeScript', 'Tailwind CSS', 'Framer Motion'],    pages: ['Home', 'Classes', 'Trainers', 'Plans', 'Book', 'Locations'],      description: 'Modern gym and fitness studio website with class booking and plans.' },
  ...
  { id: '44', title: 'LaunchConf — Event',         demoUrl: '/preview/event',             techStack: ['React', 'TypeScript', 'Tailwind CSS', 'Framer Motion'],    pages: ['Home', 'Speakers', 'Schedule', 'Tickets', 'Venue'],               description: 'Conference and event landing page with speakers, schedule, and tickets.' },
  ...
  { id: '47', title: 'Aria — Photography',         demoUrl: '/preview/photography',       techStack: ['React', 'TypeScript', 'Tailwind CSS', 'Lightgallery'],     pages: ['Home', 'Work', 'About', 'Services', 'Contact', 'Book Session'],   description: 'Stunning masonry portfolio for photographers with gallery and booking.' },
  ...
  { id: '50', title: 'Nomad — Remote Jobs',        demoUrl: '/preview/job-board',         techStack: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Supabase'],       pages: ['Home', 'Jobs', 'Companies', 'Post a Job', 'Saved Jobs'],          description: 'Remote job board for digital nomads with filters and company profiles.' },
  { id: '51', title: 'Verse — Poetry & Lit',       demoUrl: '/preview/newsletter',        techStack: ['Next.js', 'MDX', 'Tailwind CSS'],                          pages: ['Home', 'Poetry', 'Fiction', 'Authors', 'Submit', 'About'],        description: 'Literary magazine template with featured poems and author profiles.' },
  { id: '52', title: 'Roam — Airbnb Style',        demoUrl: '/preview/real-estate',       techStack: ['Next.js', 'TypeScript', 'Mapbox', 'Stripe', 'Supabase'],   pages: ['Home', 'Search', 'Listing', 'Book', 'Dashboard', 'Messages'],     description: 'Vacation rental platform with map search, property cards, and booking.' },
  ...
  { id: '54', title: 'Pixel — Game Studio',        demoUrl: '/preview/luminary',          techStack: ['React', 'TypeScript', 'Three.js', 'Tailwind CSS'],         pages: ['Home', 'Games', 'Game Detail', 'Team', 'Press', 'Careers'],       description: 'Video game studio website with game showcases, trailers, and press kit.' },
  { id: '55', title: 'Scout — Talent Agency',      demoUrl: '/preview/agency-pro',        techStack: ['React', 'TypeScript', 'Tailwind CSS', 'Framer Motion'],    pages: ['Home', 'Talent', 'Profile', 'Book', 'News', 'Contact'],           description: 'Talent and modeling agency website with portfolio grid and booking form.' },
];
